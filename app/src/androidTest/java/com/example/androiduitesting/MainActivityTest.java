...
public class MainActivityTest {
    ...
    public void testSwitchView(){
        ...
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
        //try clicking the city
        onView(withId(R.id.city_list)).perform(click());

        //check if an item that only appears on the ShowActivity screen is displayed
        onView(withId(R.id.display_city_text)).check(matches(isDisplayed()));
    }


    @Test
    public void testTextConsistency(){
        // Add a city
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Edmonton"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        //now see if the text on the new page really contains what we typed, "Edmonton"
        onView(withId(R.id.display_city_text)).check(matches((withText("Edmonton"))));
    }
    ...
    public void testBackButton(){
        ...
        //check that we're back on MainActivity by seeing if an item only displayed there is displayed
